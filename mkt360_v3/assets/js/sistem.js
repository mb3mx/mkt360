...
pin_img_e1.addEventListener('hoverenter', function () {
  title_pin('Banner promocional de SONY.', 'entrou') // funcao, coloca o titulo que deseja e se o mouse entrou ou saiu do pino
  if (vmacess == 1) {
    stop_acess()
    audio_pino1.play()
  }
...
pin_img_e1.addEventListener('hoverleave', function () {
  title_pin('Banner promocional de SONY.', 'saiu')
  if (vmacess == 1) {
    audio_pino1.pause()
...
pin_inf_e1.addHoverText('Baños accesibles.', 60)
pin_inf_e1.addEventListener('hoverenter', function () {
  if (vmacess == 1) {
    stop_acess()
    audio_pino3.play()
  }
  title_pin('Baño', 'entrou')
  if (vmacess != null) {
    $('#tooltip-span').click()
    $('#tooltip-span').vibrate() // ao paFssar por cima vibra
  }
})
...
pin_inf_e2.addHoverText(
  'Los desarrolladores pasarán 2 días desarrollando el tema: Smart City, VR y AR',
  100
)
pin_inf_e2.addEventListener('hoverenter', function () {
  title_pin('Lo que hacen ? ', 'entrou')
  if (vmacess == 1) {
    stop_acess()
    audio_pino4.play()
  }
...
esfera.link(
  esfera2,
  new THREE.Vector3(-2351.41, 413.39, 4385.76),
  350,
  PANOLENS.DataImage.SetaDir,
  'Hackathon'
) // onclick, localizacao, imagem, titulo para aparecer ao passar o mouse por cima
esfera.link(
  esfera3,
  new THREE.Vector3(4804.36, -113.64, 1344.71),
  350,
...
esfera.link(
  esfera4,
  new THREE.Vector3(4991.77, 91.06, 88.75),
  350,
...
esfera.link(
  esfera5,
  new THREE.Vector3(-4910.53, -340.46, -829.2),
  350,
  PANOLENS.DataImage.SetaCima,
  'Área abierta'
)
...
esfera2.link(
  esfera,
  new THREE.Vector3(4337.27, -249.45, 2464.41),
  350,
  PANOLENS.DataImage.SetaEsq,
  'Corredor'
)
...
esfera3.link(
  esfera,
  new THREE.Vector3(4 - 4805.47, -597.88, -1204.44),
  350,
  PANOLENS.DataImage.SetaCima,
  'Corredor'
)
...
esfera4.link(
  esfera,
  new THREE.Vector3(-571.64, -151.07, -4958.85),
  350,
  PANOLENS.DataImage.SetaCima,
  'Corredor'
)
...
esfera5.link(
  esfera,
  new THREE.Vector3(-2384.31, 177.83, -4381.24),
  350,
  PANOLENS.DataImage.SetaCima,
  'Corredor'
)
...
function play_acess () {
  ...
  if (vmacess == 1) {
    switch (
      v_esf // verifica qual esfera esta para ativar o audio correto
    ) {
      case 1:
        audio_esfera.play()
        break
