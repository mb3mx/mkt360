...
var mptide_container = document.getElementById('mptide_container'),
  ...
  mptide_v_prog,
  mptide_tooltipSpan,
  mptide_tooltipSpan_in_out,
  mptide_btn_acess,
  mptide_btn_acess_ok,
  mptide_btn_acess_x,
  mptide_modal_acess,
  mptide_audio_acess_inicio,
  mptide_btn_vr,
  mptide_modal_o,
  mptide_modal_o_close,
  mptide_modal_o_img,
  mptide_modal_o_caption,
  mptide_blueprint_map,
  mptide_blueprint_map_src
...
function mptide_function_js_play_acess () {
  for (var i = 0; i < audio_esfera_control.length; i++) {
    ...
    if (mptide_vmacess == 1) {
      if (mptide_v_esf == i) {
        // verifica qual esfera esta para ativar o audio correto
...
function mptide_function_js_options_user (os_bm, os_mvr, os_ma) {
  ...
  if (os_bm) {
    ...
    mptide_blueprint_map.style.display = 'none'
  }
  // modo vr
  if (os_mvr) {
  } else {
    mptide_btn_vr.style.display = 'none'
  }
  // modo acess
  if (os_ma) {
  } else {
    mptide_btn_acess.style.display = 'none'
  }
}
...
function mptide_function_js_load_index (mptide_container) {
  ...
  mptide_sph_0_pin_img_0_src.setAttribute(
    'onclick',
    'mptide_function_js_openimgmodal("assets/files/varanda.jpg","Ampla Varanda c/ vista para a rua")'
  )
  ...
  mptide_sph_0_pin_img_0_desc.innerHTML =
    'Varanda com vista para a rua coronel fulano. Piso em MDF da cor bege, possui Xm² para uma melhor acomodação.'
  ...
  mptide_sph_0_pin_aud_0_tagaud.innerHTML =
    'Seu navegador não suporta a tag de áudio ou vídeo.'
  ...
  mptide_sph_0_pin_aud_0_desc.innerHTML =
    'Uma breve explicação sobre o material feito para o rebaixamento e iluminação do teto: O forro do teto é feito de bla bla bla. Uma breve explicação sobre o material feito para o rebaixamento e iluminação do teto: O forro do teto é feito de bla bla bla.'
  ...
  mptide_sph_0_pin_frame_0_ifr.src =
    'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d470410.4644203711!2d-43.7285291259311!3d-22.910355243518918!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9bde559108a05b%3A0x50dc426c672fd24e!2sRio+de+Janeiro%2C+RJ!5e0!3m2!1spt-BR!2sbr!4v1477193178220'
  var mptide_sph_0_pin_frame_0_title = document.createElement('div')
  mptide_sph_0_pin_frame_0_title.classList.add('mptide_title')
  mptide_sph_0_pin_frame_0_title.innerHTML = 'Huatulco, Oaxaca'
  var mptide_sph_0_pin_frame_0_desc = document.createElement('div')
  mptide_sph_0_pin_frame_0_desc.classList.add('mptide_text')
  mptide_sph_0_pin_frame_0_desc.innerHTML =
    'Este Apartamento se localiza en Bahías de Huatulco.'
  ...
  mptide_sph_3_pin_frame_0_desc.innerHTML =
    'Banheira com acabamento em Mármore e com água quente. Um video breve sobre sua apresentação.'
...
pin_img_e1.position.set(4919.98, 125.3, -823.53) // posicao do pino, para saber ctrl + click na tela, ver no console
pin_img_e1.addHoverElement(
  document.getElementById('mptide_boxpin_sph_0_img_0'),
  170
) //id da div do conteudo, tamanho
...
pin_map_e1.position.set(-20.46, -245.0, -4989.3)
pin_map_e1.addHoverElement(
  document.getElementById('mptide_boxpin_sph_0_frame_0'),
  170
)
...
pin_aud_e1.addHoverElement(
  document.getElementById('mptide_boxpin_sph_0_aud_0'),
  170
)
...
// linha da TIMELINE
pin_timeline = new PANOLENS.Infospot(
  37,
  PANOLENS.DataImage.timeline,
  true,
  false
)
pin_timeline.position.set(2310.0, 360.0, 4937.3)
...
pin_inf_e2.position.set(1309.44, -2970.1, 3798.0)
pin_inf_e2.addHoverText(
  'Una estufa integrada de 4 quemadores, con un diseño elegante y acabado cromado.',
  100
)
pin_inf_e2.addEventListener('hoverenter', function () {
  mptide_function_js_tooltip_showoff('Explicación de la estufa.', 'entrou')
  if (mptide_vmacess != null) {
    $('#mptide_tooltip_span').click()
    $('#mptide_tooltip_span').vibrate() // ao passar por cima vibra
  }
...
pin_inf_e2.addEventListener('hoverleave', function () {
  mptide_function_js_tooltip_showoff('Explicación de la estufa.', 'saiu')
})
...
pin_vid_e4.addHoverElement(
  document.getElementById('mptide_boxpin_sph_3_frame_0'),
  170
)
pin_vid_e4.addEventListener('hoverenter', function () {
  mptide_function_js_tooltip_showoff('Vídeo sobre el baño', 'entrou')
  if (mptide_vmacess != null) {
    $('#mptide_tooltip_span').click()
    $('#mptide_tooltip_span').vibrate() // ao passar por cima vibra
  }
...
pin_vid_e4.addEventListener('hoverleave', function () {
  mptide_function_js_tooltip_showoff('Vídeo sobre el baño', 'saiu')
})
...
esfera.link(
  esfera2,
  new THREE.Vector3(-2749.16, -768.66, -4096.93),
  350,
  PANOLENS.DataImage.SetaCima,
  'Cocina'
) // onclick, localizacao, imagem, titulo para aparecer ao passar o mouse por icma
esfera.link(
  esfera3,
  new THREE.Vector3(-4351.98, -145.9, -2444.49),
  350,
  PANOLENS.DataImage.SetaDir,
  'Cuarto'
)
esfera.link(
  esfera4,
  new THREE.Vector3(-3774.11, -135.75, -3265.08),
  350,
  PANOLENS.DataImage.SetaDir,
  'Baño'
)
...
esfera2.link(
  esfera,
  new THREE.Vector3(1985.87, -1532.8, 4321.7),
  350,
  PANOLENS.DataImage.SetaCima,
  'Sala'
)
esfera2.link(
  esfera3,
  new THREE.Vector3(-1998.14, -83.72, 4577.85),
  350,
  PANOLENS.DataImage.SetaEsq,
  'Cuarto'
)
esfera2.link(
  esfera4,
  new THREE.Vector3(-4753.31, -642.44, 1378.73),
  350,
  PANOLENS.DataImage.SetaCima,
  'Baño'
)
...
esfera3.link(
  esfera,
  new THREE.Vector3(4270.45, 222.91, 2575.84),
  350,
  PANOLENS.DataImage.SetaEsq,
  'Sala'
)
esfera3.link(
  esfera2,
  new THREE.Vector3(4368.92, -335.5, 2394.88),
  350,
  PANOLENS.DataImage.SetaDiaCimaDir,
  'Cocina'
)
...
esfera4.link(
  esfera2,
  new THREE.Vector3(-3789.94, -114.17, 3246.89),
  350,
  PANOLENS.DataImage.SetaEsq,
  'Cocina'
)
